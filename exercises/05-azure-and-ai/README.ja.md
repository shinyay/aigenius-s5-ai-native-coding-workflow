# Exercise 05 -- Azure + AI：クラウドネイティブへの拡張
...
Exercise 01のOption Aとして、次の内容をIssueへ貼り付けて使用できます。
...
## 発展課題：クラウド + AIの拡張を完成させる

Exercise 01で選んだ機能に応じて、次に実施するOptionを決めます。

- Option Aを完了した場合は、Option 2（Azure OpenAI）へ進みます。
- Option Bを完了した場合は、Option 1（Azure Table Storage）へ進みます。
- Option CまたはDを完了した場合は、Option 1、Option 2の順に実施します。
